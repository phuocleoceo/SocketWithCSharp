    ...
    class Program
    {
        ...
        public static async Task RunWebServerAsync(params string[] prefixes)
        {
            if (!HttpListener.IsSupported)
                throw new Exception("This server not support HttpListener !");
            ...
            do
            {
                ...
                {
                    Console.WriteLine($"{request.HttpMethod} {request.RawUrl} Error {response.StatusCode}");
                    continue;
                }
                ...
                byte[] buffer = GenerateHTML(context.Request);
        ...
        public static byte[] GenerateHTML(HttpListenerRequest request)
        {
